...
const RestorePage = () => {
  ...
  return (
    <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-4 sm:mb-0 mb-8 min-h-[80vh]">
      <h1 className="mx-auto max-w-4xl font-display text-4xl font-bold tracking-normal text-slate-900 sm:text-6xl mb-5">
        Restore any photo
      </h1>
      <p className="text-slate-500">
        You have <span className="font-semibold">unlimited generations</span>{" "}
        left.
        <span className="font-semibold"> Its 100% free.</span>
      </p>

      <div className="flex flex-col items-center justify-center rounded-lg border-4 border-dashed px-4 py-10 max-w-2xl w-full mt-12">
        <svg
