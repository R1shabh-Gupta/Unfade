  ...
  return (
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-20">
        <a
          href="https://github.com/R1shabh-Gupta/Unfade"
          target="_blank"
          rel="noreferrer"
          className="border rounded-2xl py-1 px-4 text-slate-500 text-sm mb-5 hover:scale-105 transition duration-300 ease-in-out"
        >
          Give us a star on <span className="font-semibold">GitHub</span>!
        </a>

        <h1 className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl">
          Restoring old photos{" "}
          <span className="relative inline-flex justify-center whitespace-nowrap text-[#3290EE]">
            <SquigglyLines />
        ...
        <div className="group relative mt-6 inline-flex">
          ...
          <div className="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-black/60 md:inline-flex">
            <svg
              viewBox="0 0 82 35"
              fill="none"
          ...
          <div className="flex flex-col space-y-10 mt-4 mb-16">
            <div className="flex sm:space-x-2 sm:flex-row flex-col">
              <div>
                ...
                <Image
                  alt="Original photo of a house"
                  src="/imageToBeRestored.webp"
              ...
              <div className="sm:mt-0 mt-8">
                ...
                <Image
                  alt="Restored photo of the house"
                  width={400}
                  height={400}
                  src="/restoredImage.webp"
